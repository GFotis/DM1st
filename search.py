...
def selections():
    ...
    choosen = {
        "Execution": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "LastName": {"choosen": tk.BooleanVar(), "type":  tk.StringVar("not_choosen")},
        "FirstName": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen") },
        "TDCJNumber": {"choosen": tk.BooleanVar(), "type":  tk.StringVar("not_choosen")},
        "Age": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen") },
        "Race": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "CountyOfConviction": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "AgeWhenReceived": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "EducationLevel": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "NativeCounty": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "PreviousCrime": {"choosen": tk.BooleanVar(), "type":  tk.StringVar("not_choosen")},
        "Codefendants": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "NumberVictim ": {"choosen": tk.BooleanVar(), "type":  tk.StringVar("not_choosen")},
        "WhiteVictim": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "HispanicVictim": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "BlackVictim": {"choosen": tk.BooleanVar(), "type":  tk.StringVar("not_choosen")},
        "VictimOther Races": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "FemaleVictim": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
        "MaleVictim": {"choosen": tk.BooleanVar(), "type": tk.StringVar("not_choosen")},
